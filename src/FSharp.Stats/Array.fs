...
module Array =
    ...
    /// <summary>
    ///   Computes the population covariance of two random variables generated by applying function to the input array.
    /// </summary>
    ///    
    ...
    /// <summary>
    ///   Computes the sample covariance of two random variables generated by applying function to the input array.
    /// </summary>
    ///    
    /// <param name="f">A function applied to transform each element of the input array into a tuple of paired observations.</param>
    /// <param name="array">The input array.</param>
